  ...
  const posts = [
    {
      ...
      content: 'Excellente session de mentoring aujourd\'hui avec 3 startups prometteuses ! 🚀 Il est fascinant de voir comment une simple question peut débloquer des mois de réflexion. Mon conseil du jour : n\'ayez pas peur de remettre en question vos hypothèses de base.',
      ...
      bookmarked: false,
      type: 'image',
      tags: ['mentoring', 'startup', 'conseil']
    },
    {
      id: 2,
      author: {
      ...
      content: 'Retour d\'expérience sur notre dernière campagne de growth hacking : +300% d\'acquisition en 2 mois ! 📈\n\nLes clés du succès :\n✅ Tests A/B rigoureux\n✅ Optimisation du funnel\n✅ Automation intelligente\n✅ Analyse des données en temps réel\n\nQui veut connaître les détails ? 👇',
      ...
      bookmarked: true,
      type: 'text',
      tags: ['growth', 'marketing', 'résultats']
    },
    {
      id: 3,
      author: {
      ...
      content: 'Nouvelle vidéo sur l\'architecture microservices ! Dans cette série, je partage les bonnes pratiques pour scaler une application de 0 à 1M d\'utilisateurs. Episode 1 : Les fondamentaux.',
      videoUrl: 'https://example.com/video.mp4',
      videoThumbnail: 'https://images.pexels.com/photos/574071/pexels-photo-574071.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop',
      ...
      bookmarked: false,
      type: 'video',
      tags: ['tech', 'architecture', 'tutorial']
    },
    {
      id: 4,
      author: {
      ...
      content: 'Participer au Startup Weekend Paris a été une expérience incroyable ! 48h pour créer une solution innovante avec une équipe formidable. Notre projet "EcoTrack" a remporté le prix du public ! 🏆\n\nMerci à tous les participants et organisateurs. Vivement le prochain !',
      image: 'https://images.pexels.com/photos/1367269/pexels-photo-1367269.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop',
      ...
      bookmarked: false,
      type: 'image',
      tags: ['événement', 'startup', 'innovation']
    },
    {
      id: 5,
      author: {
      ...
      content: '💡 Astuce finance du jour : Saviez-vous que 70% des startups échouent à cause de problèmes de trésorerie ?\n\nMes 3 conseils pour éviter ce piège :\n1️⃣ Prévisions de trésorerie sur 18 mois minimum\n2️⃣ Diversification des sources de revenus\n3️⃣ Réserve de sécurité = 6 mois de charges\n\n#FinanceStartup #Entrepreneuriat',
    ...
    if (newPostContent.trim()) {
      const newPost = {
        ...
        author: {
          ...
          avatar: user?.avatar || 'https://images.pexels.com/photos/1680172/pexels-photo-1680172.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&fit=crop'
        },
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-8 animate-fade-in">
      ...
      <div className="space-y-4 md:space-y-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
        {filteredPosts.map((post, index) => (
          <article key={post.id} className="bg-white rounded-xl md:rounded-2xl shadow-soft border border-gray-100 overflow-hidden hover:shadow-medium transition-all duration-300 animate-slide-up" style={{ animationDelay: `${0.1 * index}s` }}>
            {/* Post Header */}
            <div className="p-4 md:p-6 border-b border-gray-100">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  />
                  <div>
                    <h3 className="font-semibold text-primary-900 text-sm md:text-base">{post.author.name}</h3>
                    <p className="text-xs md:text-sm text-gray-600">{post.author.profession}</p>
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className={`p-1.5 md:p-2 rounded-lg transition-colors ${
                      post.bookmarked ? 'text-gold-600 bg-gold-100' : 'text-gray-400 hover:text-gray-600 hover:bg-gray-100'
                    }`}
                  >
          ...
          <div className="bg-white rounded-t-3xl md:rounded-2xl p-4 md:p-6 w-full max-w-lg mx-0 md:mx-4 animate-scale-in fixed bottom-0 md:relative md:bottom-auto">
            ...
            <div className="flex items-center space-x-3 mb-4 md:mb-4">
              ...
              <div>
                ...
                <div className="text-xs md:text-sm text-gray-500">{user?.profession}</div>
              </div>
            </div>
