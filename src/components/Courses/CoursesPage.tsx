  ...
  const courses = [
    {
      ...
      instructor: 'Dr. Claude Nyamsi',
      description: 'Apprenez à créer et valider votre modèle économique adapté au marché camerounais',
      duration: '2h 30m',
      level: 'beginner',
      category: 'business',
      rating: 4.8,
    ...
    {
      id: 2,
      title: 'Financement des Startups au Cameroun',
      instructor: 'Mme. Sylvie Nana',
      description: 'Découvrez les sources de financement locales et les stratégies de levée de fonds au Cameroun',
      duration: '3h 15m',
      level: 'intermediate',
      category: 'finance',
      rating: 4.9,
    ...
    },
    {
      ...
      instructor: 'Paul Biya Kamga',
      description: 'Maîtrisez les stratégies de marketing digital adaptées au marché africain',
      duration: '4h 00m',
      level: 'intermediate',
      category: 'marketing',
      rating: 4.7,
    ...
    {
      id: 4,
      title: 'Innovation Technologique au Cameroun',
      instructor: 'Christian Ngan',
      description: 'Développez des solutions technologiques innovantes pour le marché local',
      duration: '6h 45m',
      level: 'advanced',
      category: 'tech',
      rating: 4.6,
    ...
    {
      id: 5,
      title: 'Leadership en Entreprise Africaine',
      instructor: 'Alain Nkontchou',
      description: 'Développez votre leadership dans le contexte culturel africain',
      duration: '2h 15m',
      level: 'intermediate',
      category: 'business',
      rating: 4.8,
    ...
    },
    {
      ...
      instructor: 'Rebecca Etoundi',
      description: 'Maîtrisez la gestion financière adaptée aux PME camerounaises',
      duration: '3h 30m',
      level: 'beginner',
      category: 'finance',
      rating: 4.5,
