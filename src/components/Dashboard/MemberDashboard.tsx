...
import Formation from "../../assets/formations.jpg";
...
const MemberDashboard: React.FC = () => {
  ...
  const upcomingEvents = [
    {
      id: 1,
      title: "Webinaire: Lever des fonds en 2025",
      date: "15 Jan",
      time: "14:00",
      attendees: 156,
    },
          ...
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-primary-100 mt-1 text-sm md:text-base">
                Continuez votre parcours entrepreneurial avec nos formations
                personnalisées
              </p>
            </div>
          </div>
      ...
      >
        {stats.map((stat, index) => {
          ...
          return (
            <div
              key={index}
              className="group relative overflow-hidden bg-white rounded-2xl shadow-soft border border-gray-100 hover:shadow-medium transition-all duration-500 hover:scale-105"
            >
              <div
              ...
              <div className="relative p-6">
                <div className="flex items-center justify-between mb-4">
                  <div
                    className={`p-3 rounded-xl bg-gradient-to-r ${stat.color} text-white shadow-soft`}
                  >
          ...
          <div className="bg-white rounded-2xl shadow-soft border border-gray-100 overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              {recentCourses.map((course, index) => (
                <div
                  key={course.id}
                  className="group border border-gray-100 rounded-2xl p-4 hover:border-primary-200 hover:bg-primary-50/50 transition-all duration-300 animate-slide-up"
                    ...
                    <div className="flex items-start space-x-3 mb-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between mb-2">
                          ...
                          <span
                            className={`ml-2 px-2 py-1 text-xs rounded-full flex-shrink-0 ${getDifficultyColor(
                              course.difficulty
                            )}`}
                          >
                            {course.difficulty}
          ...
          <div className="bg-white rounded-2xl shadow-soft border border-gray-100 overflow-hidden">
            ...
            <div className="p-6 space-y-4 scrollbar-hide">
              {upcomingEvents.map((event, index) => (
                <div
                  key={event.id}
                  className="group border border-gray-100 rounded-2xl p-4 hover:border-gold-200 hover:bg-gold-50/50 transition-all duration-300 animate-slide-up"
                  style={{ animationDelay: `${0.1 * index}s` }}
                >
